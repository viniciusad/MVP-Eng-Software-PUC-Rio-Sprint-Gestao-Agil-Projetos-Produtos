Checklist para você acompanhar a entrega do MVP conforme requisitos da PUC-Rio:

### 📦 Repositório GitHub
- [x] Criar um repositório público no GitHub exclusivo para esta entrega.
- [x] Testar o acesso público à URL do repositório, preferencialmente em uma janela anônima.

### 🎨 MVP Canvas (Miro) - *Concluído*
- [x] Criar o MVP Canvas no Miro (incluindo contexto, escopo mínimo, público-alvo e proposta de valor) através da Lean Inception.
- [x] Criar um arquivo chamado `canvas-url.txt` contendo a URL do board do Miro com todas as etapas realizadas.
...
- [x] Exportar e salvar os protótipos do Figma como imagens.
- [x] Criar uma pasta chamada `wireframes/` na raiz do repositório e adicionar as imagens nela.

### 🎥 Vídeo de Apresentação
- [ ] Gravar um vídeo de **2 a 4 minutos** em formato de *showcase* do projeto, destacando o valor central do MVP e o que será entregue na primeira sprint.
- [ ] Salvar o arquivo de vídeo na raiz do repositório **OU** fornecer a URL do vídeo (no README, por exemplo).

### 🚀 Entrega Final
- [ ] Copiar a URL pública do seu repositório do GitHub e enviar como a entrega oficial do seu MVP.
